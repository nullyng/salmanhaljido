package com.salmanhaljido.demo.domain.mart.service;
...
public class MartServiceImpl implements MartService {
    ...
    public void getData() throws Exception {
        ...
        URL url = new URL("https://www.localdata.go.kr/datafile/each/08_25_01_P.xlsx");

        File destination = new File(dataPath + "mart.xlsx");
        FileUtils.copyURLToFile(url,destination);

        FileInputStream fileInputStream = new FileInputStream(dataPath + "mart.xlsx");
        XSSFWorkbook workbook = new XSSFWorkbook(fileInputStream);

        FileOutputStream fileOutputStream = new FileOutputStream(dataPath + "mart.data");
        ...
        File writeFile = new File(dataPath + "mart_result.json");
