...
public class AnimalSalonServiceImpl implements AnimalSalonService {
    ...
    public void getData() throws Exception {
        ...
        FileOutputStream fileOutputStream = new FileOutputStream(dataPath + "animalsalon.data");
        ...
        File writeFile = new File(dataPath + "animalsalon_result.json");
        fileOutputStream = new FileOutputStream(writeFile);

        Map<String, Long> map = rdds.countByValue();
        for(String str : map.keySet()){
            org.json.JSONObject value = new JSONObject();
