package com.salmanhaljido.demo.domain.concerthall.service;
...
public class ConcertHallServiceImpl implements ConcertHallService {
    ...
    public void getData() throws Exception {
        ...
        URL url = new URL("https://www.localdata.go.kr/datafile/each/03_06_01_P.xlsx");

        File destination = new File(dataPath + "concerthall.xlsx");
        FileUtils.copyURLToFile(url,destination);

        FileInputStream fileInputStream = new FileInputStream(dataPath + "concerthall.xlsx");
        XSSFWorkbook workbook = new XSSFWorkbook(fileInputStream);

        FileOutputStream fileOutputStream = new FileOutputStream(dataPath + "concerthall.data");
        ...
        SparkSession session = SparkSession.builder()
                .master("local")
                .appName("concerthall")
                .config("spark.mongodb.write.connection.uri", "mongodb://admin:salmand110@j7d110.p.ssafy.io/openapi.concerthall?authSource=admin")
                .getOrCreate();

        Dataset<Row> df = session.read().text(dataPath + "concerthall.data");
        ...
        File writeFile = new File(dataPath + "concerthall_result.json");
